...
if __name__ == "__main__":
    ...
    while True:
        ...
        if "wikipedia" in query:
            ...
            webbrowser.open("https://www.msn.com/en-in/weather/today/Angul,OR,India/we-city?iso=IN&el=udwJf%2F%2B%2BZgmvekjRsecTCA%3D%3D&ocid=ansmsnweather")
            ...
            ans_m = " For your information Pravat Kumar Created me ! I give Lot of Thannks to Him "
            print(ans_m)
            speak(ans_m)
